...
function prepareMonForSaving(sgroup: SGroup, mol: Struct): void {
  sgroup.atoms = SGroup.getAtoms(mol, sgroup);
}

function prepareMixForSaving(sgroup: SGroup, mol: Struct): void {
  sgroup.atoms = SGroup.getAtoms(mol, sgroup);
}

function prepareComForSaving(sgroup: SGroup, mol: Struct): void {
  sgroup.atoms = SGroup.getAtoms(mol, sgroup);
}
