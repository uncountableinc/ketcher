 ...
 */
export const getFullscreenElement = (ketcherId: string): HTMLElement => {
  const fullscreenElementOverride: HTMLElement | null = document.querySelector(
    ketcherIdCssSelector(ketcherId),
  );
  if (fullscreenElementOverride != null) {
    return fullscreenElementOverride;
  }
